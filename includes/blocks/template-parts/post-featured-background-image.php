...
class PostFeaturedBackgroundImage extends \Getwid\Blocks\New\AbstractBlock {

	protected static $assets_handle = 'getwid/template-parts';

	public function __construct() {

		parent::__construct( 'getwid/template-post-featured-background-image' );

		register_block_type(
			getwid_get_plugin_path( 'assets/blocks/template-parts/post-featured-background-image' ),
			array(
	...
	public function render_callback( $attributes, $content ) {
		...
		if ( isset( $attributes['linkTo'] ) && 'none' !== $attributes['linkTo'] ) {
			$wrapper_class .= ' has-link has-link-to-' . esc_attr( $attributes['linkTo'] );
		}
...
getwid()->blocksManager()->addBlock(
	new PostFeaturedBackgroundImage()
);
