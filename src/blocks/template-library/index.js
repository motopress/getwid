...
function addToolbarButton(){
	$('.edit-post-header-toolbar').append(`<button id="getwid-layout-insert-button" class="components-button components-icon-button is-button is-secondary is-large">${ __( 'Template Library', 'getwid' ) }</button>`);
