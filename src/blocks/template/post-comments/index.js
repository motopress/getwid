...
registerBlockType( 'getwid/template-post-comments', {
	...
	category: (Getwid.settings.post_type == 'getwid_template_part' ? 'getwid-post-blocks' : 'getwid-blocks'),
	keywords: [
	],
	supports: {
		anchor: true,
		inserter: (Getwid.settings.post_type == 'getwid_template_part' ? true : false), //Show Only on Templates page
	},
