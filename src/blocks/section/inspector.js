...
class Inspector extends Component {
	...
	renderDividersSettings(){
		...
		const dividersOptions = [
			...
			{value: 'zigzag-pattern-negative-new', label: __('* Zigzag Pattern Negative New', 'getwid')},
			...
			{value: 'waves-pattern-negative-new', label: __('* Waves Pattern Negative New', 'getwid')},
			...
			{value: 'curve-asymmetrical-left-top-negative-new', label: __('C* urve Left Top Negative New', 'getwid')},
