...
class Inspector extends Component {
	...
	renderDividersSettings(){
		...
		const dividersOptions = [
			...
			{value: 'curve-asymmetrical-left-down-negative-new', label: __('* Curve Left Down Negative New', 'getwid')},
			...
			{value: 'curve-asymmetrical-left-down-new', label: __('* Curve Left Down New', 'getwid')},
