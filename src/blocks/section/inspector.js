...
/* tilt */
			...
			{value: 'opacity-tilt', label: __('Tilt Layered', 'getwid')},
			{value: 'opacity-tilt-2', label: __('Tilt Layered 2 ', 'getwid')},
			{value: 'opacity-tilt-3', label: __('Tilt Layered 3', 'getwid')},
/* split */
...
/* triangle */
			...
			{value: 'opacity-triangle-asymmetrical', label: __('Triangle Layered Asymmetrical', 'getwid')},
/* waves */
...
/* curve */
			...
			{value: 'curve-asymmetrical-left-down-negative', label: __('Curve Layered 1', 'getwid')},
			{value: 'curve-asymmetrical-right-down-negative', label: __('Curve Layered 2', 'getwid')},
			{value: 'curve-asymmetrical-left-down', label: __('Curve Layered 3', 'getwid')},
			{value: 'curve-asymmetrical-right-down', label: __('Curve Layered 4', 'getwid')},
/* zigzag */
			{value: 'zigzag', label: __('Zigzag', 'getwid')},
			{value: 'zigzag-negative', label: __('Zigzag Negative', 'getwid')},
			{value: 'zigzag-peaks', label: __('Zigzag Peaks', 'getwid')},
