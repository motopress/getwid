const attributes = {
	...
	sliderImages: {
		...
		source: 'query',
		selector:
			'.wp-block-getwid-section__background-slider>.wp-block-getwid-section__background-slider-item',
		query: {
			url: {
				source: 'attribute',
				selector: 'img',
	...
	sliderAnimationEffect: {
		...
		source: 'attribute',
		selector:
			'.wp-block-getwid-section__background-holder .wp-block-getwid-section__background-slider',
	...
	backgroundVideoMute: {
		...
		source: 'attribute',
		selector:
			'.wp-block-getwid-section__background-holder .wp-block-getwid-section__background-video.source-media-library',
		attribute: 'muted',
		default: false,
	},
	backgroundVideoLoop: {
