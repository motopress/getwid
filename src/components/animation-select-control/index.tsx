...
const entranceAnimations = [
	...
	{
		value: 'bounceInDownShort',
		label: __( 'Bounce In Down Short', 'getwid' ),
	},
	{ value: 'bounceInLeft', label: __( 'Bounce In Left', 'getwid' ) },
	{
		value: 'bounceInLeftShort',
		label: __( 'Bounce In Left Short', 'getwid' ),
	},
	{ value: 'bounceInRight', label: __( 'Bounce In Right', 'getwid' ) },
	{
		value: 'bounceInRightShort',
		label: __( 'Bounce In Right Short', 'getwid' ),
	},
	...
	{
		value: 'lightSpeedInShort',
		label: __( 'Light Speed In Short', 'getwid' ),
	},
	// Rotate
	...
	{ value: 'rotateInDownLeft', label: __( 'Rotate In Down Left', 'getwid' ) },
	{
		...
		label: __( 'Rotate In Down Right', 'getwid' ),
	},
	...
	{
		value: 'slideInRightShort',
		label: __( 'Slide In Right Short', 'getwid' ),
	},
...
const exitAnimations = [
	...
	{ value: 'rotateOut', label: __( 'Rotate Out', 'getwid' ) },
	{
		...
		label: __( 'Rotate Out Down Left', 'getwid' ),
	},
	{
		value: 'rotateOutDownRight',
		label: __( 'Rotate Out Down Right', 'getwid' ),
	},
...
export default function AnimationSelectControl( {
	...
	help,
	value,
	allowAnimation = [ 'Entrance', 'Exit', 'Seeker', 'Icon' ],
}: AnimationSelectControlProps ) {
	let animations: { value: string; label: string }[] = [
