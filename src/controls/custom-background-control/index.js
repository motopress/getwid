			...
			>
					<ButtonGroup className="components-getwid-background-types-group">
						...
						{ types.includes('gradient') && (
							<IconButton
								icon={<svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" viewBox="0 0 20 20" style={{enableBackground : 'new 0 0 20 20'}}><path d="M2,3v14c0,0.55,0.45,1,1,1h14c0.55,0,1-0.45,1-1V3c0-0.55-0.45-1-1-1H3C2.45,2,2,2.45,2,3z M15,16H4L16,4v11 C16,15.55,15.55,16,15,16z"/></svg>}
